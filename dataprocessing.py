...
np.save('./data/x_train', train)
np.save('./data/y_train', train_label)

np.save('./data/x_valid', valid)
np.save('./data/y_valid', valid_label)

np.save('./data/x_test', test)
np.save('./data/y_test', test_label)
